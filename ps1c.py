def part_b():
    starting_salary = int(input("Entrez votre salaire mensuel: "))
    ...
    if found:
        print("Votre meilleur taux d'épargne est: ", portion_saved / 10000)
        print("Étapes de la recherche en bissection: ", steps)
    else:
        print("Il n'est pas possible de payer l'acompte dans trois ans.")